...
class InicioForthScreen extends StatefulWidget {
  @override
  _InicioForthScreenState createState() => _InicioForthScreenState();
}

class _InicioForthScreenState extends State<InicioForthScreen> {
  @override
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: ClipRRect(
                                        ...
                                        child: Image.network(
                                          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcShny6rG5_6hbGobAtDOtETrvlEKdHMQSHmLw&usqp=CAU',
                                          fit: BoxFit.cover,
                                        )),
                                  ),
                                ],
